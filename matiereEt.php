                    ...
                    <div class="projects">
                        <div class="card">
                            ...
                            <div class="card-body">
                                ...
                                <p> <a href="formu1.php" > <input type="button"  class="but" value="Choisir" style="padding: 40px 30px;margin-left: 200px;
                                    border: none;
                    ...
                    <div class="customers">
                        <div class="projects">
                            <div class="card">
                                ...
                                <p> <a href="formu2.php" > <input type="button"  class="but" value="Choisir" style="padding: 40px 30px;margin-left: 200px;
                                    border: none;
                                    padding: 10px 20px;background-color: rgb(7, 216, 7);font: 1em sans-serif;"> </a>
                                </p>
